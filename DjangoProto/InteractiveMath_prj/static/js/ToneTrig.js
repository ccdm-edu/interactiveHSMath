 ...
 * interaction for test1.html which is styled by test1.css).  This code allows users to 
 * create sine waves changing the frequency, amplitude and phase and to see the new
 * equation, new plot and hear the new waveform.  Frequencies from 100 Hz to 10kHz are used.
 * 
 * DEPENDENCIES:
